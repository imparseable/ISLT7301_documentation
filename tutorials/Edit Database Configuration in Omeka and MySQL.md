...
First, find where your **db.ini** file is located. *Hint:* it should be the /var/www/html/omeka path. 

To navigate to your omeka directory and find your **db.ini** file, follow these commands:
...
This will open your **database configuration file**, which you can now edit.

## Editing your database configuration file

Navigate to the text field that reads **[database]*.
